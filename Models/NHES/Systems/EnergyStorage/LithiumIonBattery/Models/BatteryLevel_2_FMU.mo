...
//     "Boundary - Initial Charge on each cell = 0.5Ah";
  ...
  Modelica.Blocks.Interfaces.RealInput frequency_in annotation (Placement(
        transformation(extent={{140,-70},{100,-30}}), iconTransformation(extent
          ={{140,-70},{100,-30}})));
  Modelica.Blocks.Interfaces.RealOutput power_out annotation (Placement(
        transformation(extent={{100,42},{146,88}}), iconTransformation(extent={{
            100,42},{146,88}})));
equation
