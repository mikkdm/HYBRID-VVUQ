...
model Control_System_TEDS_ExpTest_Oct2024_chargeto80percent
...
equation
  ...
  connect(SensorSubBus.PV006[1], Gain.y) annotation (Line(
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(PV049_PV052.y[1], Gain2.u) annotation (Line(points={{170.8,-22},{156,
          -22},{156,-20},{139.6,-20}},        color={0,0,127}));
...
end Control_System_TEDS_ExpTest_Oct2024_chargeto80percent;
