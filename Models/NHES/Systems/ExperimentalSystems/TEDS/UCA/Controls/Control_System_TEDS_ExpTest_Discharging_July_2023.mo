...
model Control_System_TEDS_ExpTest_Discharging_July_2023
...
parameter SI.Temperature T_hot_design = 300;
  ...
  Modelica.Blocks.Sources.CombiTimeTable T_GHXout(
    tableOnFile=false,
    table=[0,25; 345,25; 700,125; 6000,125],
    tableName="T_GHX",
  ...
  Modelica.Blocks.Sources.CombiTimeTable Flow(
    tableOnFile=true,
    table=[0,12.0; 300,12.0; 500,10.0; 2000,11; 5534,11.0; 5734,13.0; 7390,12.2;
        7391,12.2],
    tableName="Flow",
    fileName=ModelicaServices.ExternalReferences.loadResource(
        "modelica://NHES/Systems/ExperimentalSystems/TEDS/ControlTables/JulyDisRestart/Flow.txt"),
      startTime=0)
    annotation (Placement(transformation(extent={{-202,48},{-184,66}})));
  ...
  Modelica.Blocks.Sources.CombiTimeTable PV006(
    tableOnFile=true,
    table=[0,0.0001; 284,0.0001; 290,1.0; 2017,1.0; 2023,0.0001; 6000,0.0001],
    tableName="table_006",
    fileName=ModelicaServices.ExternalReferences.loadResource(
  ...
  Modelica.Blocks.Sources.CombiTimeTable PV_012Position(
    tableOnFile=false,
    table=[0.0,0.0; 287,0.0; 293,1.0; 5532,1.0; 5540,0.0; 6000,0.0],
    tableName="PV_012",
...
equation
  ...
  connect(GPMconversion.y,FM_001_gpm. u1) annotation (Line(points={{-178.6,24},
          {-148,24},{-148,8.4},{-135.8,8.4}},
                                    color={0,0,127}));
  connect(Flow.y[1], VolFlow_Control.u_s) annotation (Line(points={{-183.1,57},
  ...
  connect(Conversion_lpm.y,FM_1. u1) annotation (Line(points={{-178.6,81},{-100,
          81},{-100,74.4},{-95.8,74.4}},
                           color={0,0,127}));
  connect(Flow.y[1],FM_1. u2) annotation (Line(points={{-183.1,57},{-100,57},{
          -100,63.6},{-95.8,63.6}},
                           color={0,0,127}));
...
end Control_System_TEDS_ExpTest_Discharging_July_2023;
