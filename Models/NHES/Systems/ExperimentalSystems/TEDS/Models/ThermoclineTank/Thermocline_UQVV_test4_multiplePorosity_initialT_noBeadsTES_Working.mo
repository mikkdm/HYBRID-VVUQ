...
model Thermocline_UQVV_test4_multiplePorosity_initialT_noBeadsTES_Working
  "test3_+ Nobeads Area set-up in TES"
  import TRANSFORM;
...
parameter SI.SpecificHeatCapacity Cr = 775.0 "J/kg*K ";
...
parameter Real fs=2.0 "Surface Shape Factor, between 2 and 3 
...
parameter SI.Temperature T_Init[nodes] =  {312.08, 313, 314, 315, 316, 317, 317, 317, 317, 317,
                                           ...
                                           292, 292, 292, 292, 292,
                                           292} "Initial temperature of thermocline medium and wall. Note that its number of units needs to be identical with total nodes in TES.";
...
end Thermocline_UQVV_test4_multiplePorosity_initialT_noBeadsTES_Working;
