...
model Thermocline_noInsulation_Bottom_UQVV
...
parameter SI.Length dr=0 "nominal diameter of filler material [m]";
...
//Initialization Step **********************************************
  Modelica.Fluid.Interfaces.FluidPort_a port_a(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{-10,14},{10,34}}),
        iconTransformation(extent={{-10,14},{10,34}})));
...
end Thermocline_noInsulation_Bottom_UQVV;
