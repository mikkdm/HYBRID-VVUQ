...
model Thermocline_Partial_Insulation_UQVV_v2
...
equation
  ...
  connect(port_a, thermocline_fluidprops_heaters_newHC_120C.port_a)
    annotation (Line(points={{0,100},{0,26}}, color={0,127,255}));
...
end Thermocline_Partial_Insulation_UQVV_v2;
