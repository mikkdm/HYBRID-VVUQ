...
model
  Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_SinglePorosityy_v12_Working
  "v11 + single boundary"
  ...
  ThermoclineTank.Thermocline_UQVV_test2_singlePorosity_initialT TES(
  ...
  Data.Geometry_singlePoro   geometry(
    nodes=90,
    Porosity=0.36,
    XS_Fluid=geometry.Porosity*Modelica.Constants.pi*(geometry.Radius_Tank^2.0),
...
equation
  ...
  connect(Insulation.port_b, simpleWall[1:90].port_a)
