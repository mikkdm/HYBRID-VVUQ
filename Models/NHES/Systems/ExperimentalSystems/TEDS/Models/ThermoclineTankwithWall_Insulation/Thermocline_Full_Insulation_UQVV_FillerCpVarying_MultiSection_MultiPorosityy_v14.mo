...
model
  Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_MultiPorosityy_v14
  "v12 + multiSection with multiple volume"
  ...
  parameter SI.Temperature T_Init[TES.nodes] = {317.51, 317, 317, 317, 317, 317,
                                                ...
                                                297.32}       "Initial temperature of thermocline medium and wall";
  ...
  parameter Real insRout_71 = 0.153;
  parameter Real insRout_72 = 0.153;
  parameter Real insRout_73 = 0.153;
  parameter Real insRout_74 = 0.153;
  parameter Real insRout_75 = 0.153;
  parameter Real insRout_76 = 0.153;
  parameter Real insRout_77 = 0.153;
  parameter Real insRout_78 = 0.153;
  parameter Real insRout_79 = 0.153;
  parameter Real insRout_80 = 0.153;
  parameter Real insRout_81 = 0.153;
  parameter Real insRout_82 = 0.153;
  parameter Real insRout_83 = 0.153;
  parameter Real insRout_84 = 0.153;
  parameter Real insRout_85 = 0.153;
  parameter Real insRout_86 = 0.153;
  parameter Real insRout_87 = 0.153;
  parameter Real insRout_88 = 0.153;
  parameter Real insRout_89 = 0.153;
  parameter Real insRout_90 = 0.153;
  ...
  ThermoclineTank.Thermocline_UQVV_test4_multiplePorosity_initialT_noBeadsTES_Working
    ...
    T_Init(displayUnit="K") = {317.51,317,317,317,317,317,318.36,318,318,318,
      318,318,317.26,317,317,317,317,316,316.06,316,316,316,316,314.36,314,313,
      312,311,311,311.72,311,311,311,310,310,309.14,309,309,308,307,307.24,307,
      306,305,304,304,304.03,304,303,302,301,301,301.52,301,301,300,299,299,
      299.07,299,299,299,298,297.32,292,297,297,297,297,297.32})
  ...
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder simpleWall[90](
    ...
    annotation (Placement(transformation(extent={{-52,6},{-36,22}})));

  Modelica.Blocks.Sources.RealExpression boundaryT[90](y=fill(geometry.T_amb, 90))
    annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=270,
        origin={-100,-10})));
  TRANSFORM.HeatAndMassTransfer.BoundaryConditions.Heat.Temperature_multi
    boundary2(nPorts=90,             use_port=true) annotation (Placement(
        transformation(
        extent={{6,-6},{-6,6}},
        rotation=180,
        origin={-88,14})));
  TRANSFORM.HeatAndMassTransfer.Volumes.SimpleWall_Cylinder Insulation[90](
    ...
    r_outer=fill(geometry.Radius_Tank + geometry.Wall_Thickness, geometry.nodesTotal)
        ...
        insRout_67,insRout_68,insRout_69,insRout_70,insRout_71,insRout_72,
        insRout_73,insRout_74,insRout_75,insRout_76,insRout_77,insRout_78,
        insRout_79,insRout_80,insRout_81,insRout_82,insRout_83,insRout_84,
        insRout_85,insRout_86,insRout_87,insRout_88,insRout_89,insRout_90},
    redeclare package Material = InsulationMaterial,
    T_start=303.15)
    annotation (Placement(transformation(extent={{-74,6},{-58,22}})));
  ...
  Data.Geometry_multiplePoro geometry(
    ...
    Height_Tank=3.55,
    XS_Fluid={0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,
        0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,
        0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,
        0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,
        0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36,0.36}*Modelica.Constants.pi
        *(geometry.Radius_Tank^2.0),
    T_amb=293.15) annotation (Dialog(group="Geometry"), Placement(
        transformation(extent={{-98,76},{-76,98}})));

  TRANSFORM.Fluid.Volumes.MixingVolume_multiHeatport TES_Top(
    ...
    nPorts_b=1) annotation (Placement(transformation(
        ...
        rotation=90,
        origin={0,62})));
  TRANSFORM.Fluid.Volumes.MixingVolume_multiHeatport TES_Bottom(
    redeclare package Medium =
        TRANSFORM.Media.Fluids.Therminol_66.LinearTherminol66_A_250C,
    T_start=313.15,
    redeclare model Geometry =
...
equation
  ...
  connect(boundaryT.y, boundary2.T_ext) annotation (Line(points={{-100,1},{-100,
          14},{-90.4,14}},            color={0,0,127}));
  connect(boundary2.port, Insulation.port_a)
    annotation (Line(points={{-82,14},{-74,14}}, color={191,0,0}));
  connect(Insulation.port_b, simpleWall.port_a)
    annotation (Line(points={{-58,14},{-52,14}}, color={191,0,0}));
  connect(port_a, TES_Top.port_b[1]) annotation (Line(points={{0,100},{0,84},{3.88578e-16,
          84},{3.88578e-16,68}}, color={0,127,255}));
  connect(TES_Top.port_a[1], TES.port_a) annotation (Line(points={{-3.88578e-16,
          56},{-3.88578e-16,47},{0,47},{0,38}}, color={0,127,255}));
  connect(TES.port_b, TES_Bottom.port_b[1]) annotation (Line(points={{0,-10},{0,
          -21},{3.88578e-16,-21},{3.88578e-16,-32}}, color={0,127,255}));
  connect(TES_Bottom.port_a[1], port_b) annotation (Line(points={{-3.88578e-16,-44},
          {-3.88578e-16,-72},{0,-72},{0,-100}}, color={0,127,255}));
  connect(simpleWall[11:80].port_b, TES.heatPorts[:, 1])
    annotation (Line(points={{-36,14},{-24.48,14}}, color={191,0,0}));
  connect(simpleWall[1:10].port_b, TES_Top.heatPorts[1:10, 1]) annotation (Line(
        points={{-36,14},{-32,14},{-32,62},{-6,62}}, color={191,0,0}));
  connect(simpleWall[81:90].port_b, TES_Bottom.heatPorts[1:10, 1]) annotation (
      Line(points={{-36,14},{-32,14},{-32,-38},{-6,-38}}, color={191,0,0}));
