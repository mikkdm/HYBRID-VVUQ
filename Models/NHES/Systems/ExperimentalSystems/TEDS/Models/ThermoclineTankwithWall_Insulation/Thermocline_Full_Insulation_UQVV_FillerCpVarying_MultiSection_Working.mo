...
model Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_Working
  ...
  Data.Geometry_singlePoro geometry(T_amb=293.15) annotation (Dialog(group=
...
end Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_Working;
