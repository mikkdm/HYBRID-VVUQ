...
model Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_v7
  "Unnecessary data in Geometry is removed."
  ...
  ThermoclineTank.Thermocline_UQVV_test2_multiplePorosity TES(
  ...
  Data.Geometry_multiplePoro
                           geometry(
    nodes=71,
    Porosity=0.36*ones(71),
    XS_Fluid=0.36*ones(71)*Modelica.Constants.pi*(geometry.Radius_Tank^2.0),
    T_amb=293.15,
    T_ground=273.15)                              annotation (Dialog(group=
          "Geometry"), Placement(transformation(extent={{72,74},{94,96}})));
...
equation
  ...
  connect(boundaryT2.y, boundary3.T_ext) annotation (Line(points={{-96,-31},{
          -96,-30},{-84.4,-30}}, color={0,0,127}));
  ...
  connect(TES_Bottom.port_a[1], port_b) annotation (Line(points={{-3.88578e-16,
          -36},{-3.88578e-16,-58},{0,-58},{0,-100}}, color={0,127,255}));
...
end Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_v7;
