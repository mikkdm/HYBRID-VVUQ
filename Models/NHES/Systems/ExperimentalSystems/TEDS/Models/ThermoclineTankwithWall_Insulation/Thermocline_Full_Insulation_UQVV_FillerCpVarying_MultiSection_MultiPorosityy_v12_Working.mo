...
model
  Thermocline_Full_Insulation_UQVV_FillerCpVarying_MultiSection_MultiPorosityy_v12_Working
  "v11 + single boundary"
  ...
  Modelica.Blocks.Sources.RealExpression boundaryT[90](y=fill(geometry.T_amb,
        90))
