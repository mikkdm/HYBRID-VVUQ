...
equation
  ...
  connect(TC_005.port_a, TC_006.port_b) annotation (Line(points={{56,-150},{56,
          -145},{40,-145}},
                      color={0,127,255}));
  connect(FM_002.port_b, TC_004.port_b) annotation (Line(points={{124.5,-209},{
          126,-209},{126,-212},{124,-212},{124,-214}}, color={0,127,255}));
  ...
  connect(pipe8.port_b, FM_002.port_a) annotation (Line(points={{142,-186},{
          124.5,-186},{124.5,-190}}, color={0,127,255}));
