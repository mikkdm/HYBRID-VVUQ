...
model GHX_UnitSimulation_testModelwBypassLine_v3_NOTWORKING

  extends
    NHES.Systems.ExperimentalSystems.TEDS.BaseClasses_1.Partial_SubSystem_A(
    redeclare replaceable ControlSystems.CS_GlycolHX_v4 CS,
...
equation
  ...
  connect(actuatorBus.PV009_Opening, PV009.opening) annotation (Line(
      points={{30,100},{160,100},{160,-60},{10,-60},{10,-50.4}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
  ...
  connect(actuatorBus.BypassV_Glycol_Opening, BypassV_Glycol.opening)
    annotation (Line(
      points={{30,100},{160,100},{160,54},{10,54},{10,50.4}},
      color={111,216,99},
      pattern=LinePattern.Dash,
      thickness=0.5));
...
end GHX_UnitSimulation_testModelwBypassLine_v3_NOTWORKING;
