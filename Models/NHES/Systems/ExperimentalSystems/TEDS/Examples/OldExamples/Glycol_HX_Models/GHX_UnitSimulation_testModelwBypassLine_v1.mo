...
model GHX_UnitSimulation_testModelwBypassLine_v1
...
equation
  ...
  connect(PV009.port_a, TC_004.port_a)
    annotation (Line(points={{18,-46},{26,-46},{26,-4}}, color={0,127,255}));
  connect(PV009.port_b, TC_005.port_a) annotation (Line(points={{-2,-46},{-12,-46},
          {-12,-4},{-22,-4}}, color={0,127,255}));
  connect(trapezoid.y, PV009.opening)
    annotation (Line(points={{27,-70},{8,-70},{8,-54}}, color={0,0,127}));
  connect(massflow_sin.y, Oil_Mass_Flow.m_flow_in)
    annotation (Line(points={{107,-26},{64,-26},{64,-10.4}}, color={0,0,127}));
  connect(Temp_sin.y, Oil_Mass_Flow.T_in) annotation (Line(points={{107,6},{70,6},
          {70,-7.2},{65.6,-7.2}}, color={0,0,127}));
  annotation (
...
end GHX_UnitSimulation_testModelwBypassLine_v1;
