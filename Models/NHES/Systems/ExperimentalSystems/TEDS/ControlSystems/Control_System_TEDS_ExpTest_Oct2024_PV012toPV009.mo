...
model Control_System_TEDS_ExpTest_Oct2024_PV012toPV009
...
parameter SI.Temperature T_hot_design = 300;
  ...
  Modelica.Blocks.Sources.Constant const3(k=273.15)      annotation (Placement(
        ...
        rotation=0,
        origin={-198,-74})));
  Modelica.Blocks.Sources.RealExpression PV012(y=1 - PV009.y)
...
equation
  ...
  connect(const3.y,add. u2) annotation (Line(points={{-187,-74},{-158,-74},{
          -158,-62.4},{-135.8,-62.4}},
                                 color={0,0,127}));
  connect(ActuatorSubBus.TC006,PV009. u_m) annotation (Line(
  ...
  connect(PV050_PV051.y[1], Gain1.u)
    annotation (Line(points={{170.7,-65},{170.7,-66},{144,-66},{144,-51},{139.8,
          -51}},                                         color={0,0,127}));
  connect(PV009.u_s, add.y)
    annotation (Line(points={{-99.8,-57},{-115.1,-57}}, color={0,0,127}));
  connect(SensorSubBus.PV009, PV009.y) annotation (Line(
      points={{40,-99},{40,-56},{-80,-56},{-80,-57},{-79.1,-57}},
      color={239,82,82},
      pattern=LinePattern.Dash,
      thickness=0.5), Text(
      string="%first",
...
end Control_System_TEDS_ExpTest_Oct2024_PV012toPV009;
